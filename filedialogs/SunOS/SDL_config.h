...
#define SDL_VIDEO_DRIVER_KMSDRM_DYNAMIC ""
...
#define SDL_VIDEO_DRIVER_X11_DYNAMIC "libX11.so.4"
#define SDL_VIDEO_DRIVER_X11_DYNAMIC_XEXT "libXext.so.0"
#define SDL_VIDEO_DRIVER_X11_DYNAMIC_XCURSOR "libXcursor.so.1"
#define SDL_VIDEO_DRIVER_X11_DYNAMIC_XINPUT2 "libXi.so.5"
#define SDL_VIDEO_DRIVER_X11_DYNAMIC_XFIXES "libXfixes.so.1"
